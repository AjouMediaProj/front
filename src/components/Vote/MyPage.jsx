...
function MyPage() {
    ...
    return (
        <MyPageBody>
            <h1>마이페이지</h1>
            <InputWithLabel label="등급" name="accessLevel" backColor="#fbfbfb" />
            ...
            <InputWithLabel label="학과" name="major" backColor="#fbfbfb" placeholder={utils.storageManager.userInfo.major} disabled="true" />
